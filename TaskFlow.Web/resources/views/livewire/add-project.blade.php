<div id="add_project_modal" class="modal hidden" wire:ignore>
    ...
    <form wire:submit="add">
        <div style="padding-bottom: 5px; display: flex; flex-direction: column; gap: 5px;">
            Title
            <input type="text" id="title" class="will_validate" wire:model="title">
        ...
        <div style="padding-bottom: 5px; display: flex; flex-direction: column; gap: 5px;">
            ...
            <div style="position: relative; width: 100%;">
                <input type="text" id="deadline" autocomplete="off" readonly wire:model="deadline">
